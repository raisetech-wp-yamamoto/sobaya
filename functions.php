...
function my_scripts() {
  ...
  wp_enqueue_script( 'accordion.js', get_template_directory_uri() . '/js/accordion.js', array( 'jquery' ), '1.0.0', true );
  wp_enqueue_script( 'gkey.js', get_template_directory_uri() . '/js/gkey.js', array( 'jquery' ), '1.0.0', true );
}
